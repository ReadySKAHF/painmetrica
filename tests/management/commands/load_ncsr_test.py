...
SCORE_RANGES = [
    ...
    (
        ...
        'Требуется наблюдение, но не всегда указывает на необходимость срочного обезболивания.',
        1,
    ),
    (
        3, 4,
        'Умеренный ноцицептивный ответ',
        'Умеренный ноцицептивный ответ. Рассматривается как клинически значимый показатель '
        'вероятной боли/дискомфорта. Является прямым показанием к оценке текущей анальгезии '
        'и, скорее всего, к ее усилению или введению «скоропомощного» анальгетика перед процедурами.',
        1,
    ),
    (
        5, 8,
        'Выраженный ноцицептивный ответ',
        'Выраженный ноцицептивный ответ. С высокой вероятностью указывает на наличие '
        'некупированного болевого синдрома. Требует немедленной коррекции обезболивающей терапии '
        '(болюсное введение анальгетика, титрация инфузии) и диагностического поиска причины боли '
        '(новое повреждение, осложнение).',
        1,
    ),
]
