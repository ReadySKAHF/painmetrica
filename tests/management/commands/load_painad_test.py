...
SCORE_RANGES = [
    ...
    (1,  3,  'Слабая боль',             'Выявлены признаки слабой боли. Рекомендуется наблюдение.',              1),
    (4,  6,  'Боль средней тяжести',    'Выявлена боль средней тяжести. Рекомендуется коррекция терапии.',       1),
    (7,  10, 'Сильная боль',            'Выявлена сильная боль. Требуется немедленная коррекция обезболивания.', 1),
]
